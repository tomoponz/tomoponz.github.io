...
(() => {
  ...
  const OMIKUJI_POOL = [
    // 毒舌 8種類：合計 93.99%
    { rank: "凶", cls: "rank-toxic", w: 1200, msg: "いとよろしくなし。手を出すほど泥沼なり。", tips: "戒め：急ぐな。まず一息つけ。／開運：水を飲みて寝よ。" },
    { rank: "大凶", cls: "rank-toxic", w: 1200, msg: "おほかた終はる。されど今日のうちに修正すれば命はある。", tips: "戒め：大事な操作は二度三度確かむべし。／開運：バックアップ。" },
    { rank: "末凶", cls: "rank-toxic", w: 1200, msg: "末に崩るる兆し。最初の一手を誤るべからず。", tips: "戒め：着手は小さく。／開運：TODOを一つに絞れ。" },
    { rank: "凶相", cls: "rank-toxic", w: 1200, msg: "顔に書かれたり、『まだ準備せず』とな。", tips: "戒め：装備（資料・道具）を整へよ。／開運：机を片づけよ。" },
    { rank: "災凶", cls: "rank-toxic", w: 1200, msg: "災ひは外より来たるにあらず。己が油断より起こる。", tips: "戒め：見落とし一箇所が致命なり。／開運：チェックリスト。" },
    { rank: "虚凶", cls: "rank-toxic", w: 1200, msg: "中身は空、やる気も空。だが動けば生まるる。", tips: "戒め：気分を待つな。／開運：五分だけ始めよ。" },
    { rank: "笑止凶", cls: "rank-toxic", w: 1100, msg: "をかしきほどに運なし。笑ふしかなし。されど笑へ。", tips: "戒め：自滅ムーブを慎め。／開運：散歩して戻れ。" },
    { rank: "無慈悲凶", cls: "rank-toxic", w: 1099, msg: "情け容赦なし。今日の世界は君を甘やかさぬ。", tips: "戒め：一点突破せよ。／開運：通知を切れ。" },

    // ちょっといい：5%
    { rank: "ちと佳し", cls: "rank-good", w: 500, msg: "よろし。大勝ちはせずとも、堅実に利あり。", tips: "勧め：小さき成功を積め。／開運：早寝早起き、まこと大事。" },

    // ???（1%）
    { rank: "ウルトラースーパーアルティメット大吉", cls: "rank-ultra", w: 100, msg: "いみじくよし。天も地も味方せり。今引けば通る。", tips: "勧め：やりたきこと、今日のうちに放て。／開運：勢ひのまま提出せよ。" },

    // ???（0.01%）
    { rank: "凶とか大吉とか、そんなことはどうでもよくて、今世は無敵です。", cls: "rank-ultra", w: 1,
      msg: "理不尽さすら踏み台にするモードに入った。今の君は“強制クリア”のターン。",
      tips: "勧め：怖い所へ一歩。／開運：やるべき一撃を今日放て（提出・連絡・着手）。" },
  ];
